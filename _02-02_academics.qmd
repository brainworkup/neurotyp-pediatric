...
fn_percent_mastery <- gt::md("Percent Mastery: Percentage of correct raw scores")

# Define the groups for the table
grp_academics <- list(
  standard_score = c("KTEA-3", "WIAT-4", "WRAT-5", "BSRA-4"),
  percent_mastery = c("BSRA-4")
)
...
bwu::tbl_gt(
  ...
  fn_percent_mastery = fn_percent_mastery,
  grp_standard_score = grp_academics[["standard_score"]],
  grp_percent_mastery = grp_academics[["percent_mastery"]],
