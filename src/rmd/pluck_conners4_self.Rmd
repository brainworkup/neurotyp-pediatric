...
# file <- "/Users/joey/reports/Felix/data/pdf/Felix_Gibbons_FG24_Conners4_Single-RaterReport.pdf"
...
extracted_tables_lattice <- map2(areas_lattice, seq_along(areas_lattice), 
                                 ~ extract_and_save_table(.x, .y, method))

# Alternatively, using purrr::partial
extracted_tables_lattice2 <- map2(areas_lattice, seq_along(areas_lattice),
...
# Alternatively, using purrr::partial
extracted_tables_stream <- map2(areas_stream, seq_along(areas_stream),
                                 purrr::partial(extract_and_save_table, method = method))
