...
# Clean scale names
data_adhd_self <-
  dplyr::mutate(data_adhd_self,
    scale = stringr::str_remove_all(
      scale, "Conners 4 Self |CEFI Self-Report |Brown EF/A Self-Report"
    )
  )
...
# Clean scale names
data_adhd_parent <-
  dplyr::mutate(data_adhd_parent,
    scale = stringr::str_remove_all(
      scale, "Conners 4 Parent |CEFI Parent-Report |Brown EF/A Parent-Report"
    )
  )
...
# Clean scale names
data_adhd_teacher <-
  dplyr::mutate(data_adhd_teacher,
    scale = stringr::str_remove_all(
      scale, "Conners 4 Teacher |CEFI Teacher-Report |Brown EF/A Teacher-Report"
    )
  )
...
```
```{=typst}
#let title = "ADHD Self-Report Ratings"
  ...
  grid(
    ...
    figure(
      ...
      caption: figure.caption(
        position: bottom,
        [
          Parent-report of the child's ADHD symptoms and executive functioning in daily life.
        ],
      ),
      placement: none,
      kind: "image",
  ...
  grid(
    ...
    figure(
      ...
      caption: figure.caption(
        position: bottom,
        [
          Teacher-report of the child's ADHD symptoms and executive functioning in daily life.
        ],
      ),
      placement: none,
      kind: "image",
...
```
```{=typst}
#let title = "ADHD Teacher Ratings"
